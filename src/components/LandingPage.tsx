...
export default function LandingPage() {
  ...
  return (
    <div className="pt-[72px] bg-slate-50 min-h-screen text-slate-900">
      {/* Editorial Hero Section */}
      <section className="border-b border-slate-200 bg-white py-16 md:py-28 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 text-slate-800 text-xs font-semibold rounded mb-6 border border-slate-200">
              <span>Platform Update</span>
              <span className="text-slate-400">&bull;</span>
              <span className="font-normal text-slate-600">Zero platform commissions on first $1,000</span>
            </div>
            
            <h1 className="font-headline text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.08] mb-6">
              Monetize your expertise. <br />
              Own your audience.
            </h1>

            <p className="font-sans text-base md:text-lg text-slate-600 max-w-xl leading-relaxed mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center mb-10">
              <button
                ...
                className="px-6 py-3.5 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm rounded-md transition-colors focus-ring cursor-pointer"
              >
              ...
              <button
                ...
                className="px-6 py-3.5 bg-white border border-slate-300 hover:bg-slate-50 text-slate-800 font-semibold text-sm rounded-md transition-colors focus-ring cursor-pointer"
              >
                Browse Top Mentors
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-200 max-w-lg">
              <div>
                <div className="font-headline text-2xl font-bold text-slate-900">$1.4M+</div>
                <div className="text-xs font-medium text-slate-500 mt-0.5">Earnings Paid Out</div>
              </div>
              <div>
                <div className="font-headline text-2xl font-bold text-slate-900">99.4%</div>
                <div className="text-xs font-medium text-slate-500 mt-0.5">Client Satisfaction</div>
              </div>
              <div>
                <div className="font-headline text-2xl font-bold text-slate-900">&lt; 5m</div>
                <div className="text-xs font-medium text-slate-500 mt-0.5">Average Setup Time</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-slate-900 text-white p-6 rounded-lg border border-slate-800 shadow-lg">
              <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                <div className="w-12 h-12 rounded-full bg-slate-700 overflow-hidden shrink-0">
                  <img src={CREATORS[0].image} alt={CREATORS[0].name} className="w-full h-full object-cover" />
                </div>
                <div>
      ...
      <section className="py-16 md:py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
            <div>
              <h2 className="font-headline text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-2 border border-slate-300 rounded hover:bg-slate-100 text-slate-700 focus-ring cursor-pointer"
              >
            ...
            {CREATORS.slice(0, 5).map((creator) => (
              <div key={creator.id} className="min-w-[280px] md:min-w-[320px] snap-start">
                <div
                  ...
                  className="bg-white border border-slate-200 rounded-md p-5 hover:border-slate-400 transition-colors cursor-pointer flex flex-col justify-between h-full"
                >
                  <div>
                    <div className="aspect-[4/3] overflow-hidden rounded bg-slate-100 mb-4">
                      <img
                        alt={creator.name}
                    ...
                    <h3 className="font-headline text-base font-bold text-slate-900 mb-0.5">{creator.name}</h3>
                    <p className="text-xs text-slate-600 font-medium mb-3">{creator.title} at {creator.org}</p>
                    <p className="text-xs text-slate-500 line-clamp-2 leading-relaxed mb-4">{creator.bio}</p>
                  </div>
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-xs font-semibold text-slate-900">From ${creator.startingPrice}</span>
      ...
      <section ref={featuresRef} className="py-16 md:py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="max-w-xl mb-12">
            <h2 className="font-headline text-2xl md:text-3xl font-bold text-slate-900 tracking-tight mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 border border-slate-200 rounded-md">
              <div className="w-10 h-10 bg-slate-900 text-white rounded flex items-center justify-center font-bold text-sm mb-4">
                01
              </div>
              <h3 className="font-headline text-lg font-bold text-slate-900 mb-2">1:1 Mentorship & Advice</h3>
            ...
            <div className="bg-white p-6 border border-slate-200 rounded-md">
              ...
              <h3 className="font-headline text-lg font-bold text-slate-900 mb-2">Digital Deliverable Vault</h3>
              <p className="text-slate-600 text-xs md:text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 border border-slate-200 rounded-md">
              ...
              <h3 className="font-headline text-lg font-bold text-slate-900 mb-2">Cohort & Live Workshops</h3>
              <p className="text-slate-600 text-xs md:text-sm leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="max-w-xl mb-12">
            <h2 className="font-headline text-2xl md:text-3xl font-bold text-slate-900 tracking-tight mb-2">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((testimonial) => (
              <div key={testimonial.id} className="bg-slate-50 p-6 border border-slate-200 rounded-md flex flex-col justify-between">
                <p className="text-slate-800 text-xs md:text-sm leading-relaxed italic mb-6">
                  &ldquo;{testimonial.quote}&rdquo;
                </p>
                <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                  <img alt={testimonial.userName} className="w-10 h-10 rounded-full object-cover" src={testimonial.userImage} />
                  <div>
                    <div className="text-xs font-bold text-slate-900">{testimonial.userName}</div>
                    <div className="text-[11px] text-slate-500">{testimonial.userRole}</div>
                  </div>
                </div>
              </div>
            ))}
