    ...
    <footer className="w-full py-16 bg-[#ffffff] border-t border-gray-100 mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 hover:text-primary-brand hover:bg-primary-brand/5 border border-gray-100 transition-all cursor-pointer"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 hover:text-[#25D366] hover:bg-[#25D366]/5 border border-gray-100 transition-all cursor-pointer"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="pt-8 border-t border-gray-100 flex justify-center items-center">
          <p className="text-[#5f5e5e] text-xs">&copy; {new Date().getFullYear()} Leap Skills. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
