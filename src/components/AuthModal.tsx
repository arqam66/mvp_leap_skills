  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8 animate-fade-in">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-lg hover:bg-gray-100 transition-colors focus:outline-none cursor-pointer"
          aria-label="Close"
        >
        ...
        <div className="text-center mb-8">
          <h2 className="font-headline text-2xl font-bold text-[#1a1c1c] mb-2">
