...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'We charge zero platform commission fees on the first $1,000 you earn. After that, a flat 2.5% platform fee is applied to bookings. Note that standard Stripe card processing fees (~2.9% + $0.30) still apply.'
  },
  {
    category: 'payouts',
          ...
          {filteredFaqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-headline pr-4">{faq.question}</span>
                ...
                {isOpen && (
                  <div className="px-6 pb-5 text-xs md:text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-sans border-t border-slate-100 dark:border-slate-850 pt-4.5">
                    {faq.answer}
                  </div>
                )}
              </div>
