...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] dark:bg-slate-950 flex items-center justify-center px-4 pt-[72px] text-slate-900 dark:text-slate-100">
      <div className="w-full max-w-md">
        {/* Back to home */}
        <button
          type="button"
          onClick={() => router.push('/')}
          className="flex items-center gap-2 text-sm text-[#5f5e5e] dark:text-slate-400 hover:text-[#1a1c1c] dark:hover:text-white mb-8 transition-colors focus:outline-none cursor-pointer"
        >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-ambient border border-gray-100 dark:border-slate-800 p-8">
          {/* Header */}
          <div className="text-center mb-8">
            <h1 className="font-headline text-2xl font-bold text-[#1a1c1c] dark:text-white mb-2">
