  ...
  return (
    <main className="min-h-screen bg-[#f9f9f9]">
      <div className="max-w-4xl mx-auto px-6 md:px-10 py-20">
        {/* Header */}
        <div className="mb-12">
          <h1 className="font-headline text-4xl md:text-5xl font-extrabold text-[#1a1c1c] mb-4 tracking-tight">
            Terms &amp; Conditions
          </h1>
        ...
        {/* Content */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-ambient p-8 md:p-12 space-y-10">
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">2. Description of Services</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">3. User Accounts</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed mb-4">
              When you create an account with us, you must provide accurate, complete, and current information. You are responsible for:
            </p>
            <ul className="list-disc list-inside text-[#5f5e5e] text-sm leading-relaxed space-y-2 ml-2">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">4. Intellectual Property Rights</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">5. User Content</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">6. Prohibited Uses</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">7. Payments and Refunds</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">8. Disclaimer of Warranties</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">9. Limitation of Liability</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">10. Termination</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">11. Governing Law</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">12. Changes to Terms</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">13. Contact Us</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
              If you have any questions about these Terms &amp; Conditions, please contact us at:
            </p>
            <div className="mt-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
              <p className="text-sm text-[#1a1c1c] font-medium">Leap Skills</p>
              <p className="text-sm text-[#5f5e5e]">Email: hello@leapskills.sbs</p>
