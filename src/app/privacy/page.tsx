    ...
    <main className="min-h-screen bg-[#f9f9f9]">
      <div className="max-w-4xl mx-auto px-6 md:px-10 py-20">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-ambient p-8 md:p-12 space-y-10">
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">1. Introduction</h2>
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">3. How We Use Your Information</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">4. Information Sharing</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">5. Data Security</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">6. Your Rights</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed mb-4">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">7. Cookies</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">8. Third-Party Links</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">9. Children&apos;s Privacy</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">10. Changes to This Policy</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-headline text-xl font-bold text-[#1a1c1c] mb-4">11. Contact Us</h2>
            <p className="text-[#5f5e5e] text-sm leading-relaxed">
